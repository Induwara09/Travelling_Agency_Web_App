...
- Hotel CRUD and search/filter, including 3-5 star class and official website URL
- Experience CRUD, search and customer visibility controls
...
| GET | `/api/experiences` | List/search active experiences |
...
| POST/PUT/DELETE | `/api/experiences` | Manage experiences |
