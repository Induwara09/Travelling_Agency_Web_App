...
public class Hotel {
    ...
    @NotNull(message = "Hotel star rating is required")
    @Min(value = 3, message = "Only hotels with at least three stars are supported")
    @Max(value = 5, message = "Hotel star rating cannot exceed five")
    ...
    protected void onCreate() {
        ...
        if (starRating == null) starRating = 4;
    }
