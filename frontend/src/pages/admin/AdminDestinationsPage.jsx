...
export default function AdminDestinationsPage() {
  ...
  return <>
    ...
    <Modal open={open} title={editing ? 'Edit destination' : 'Add destination'} onClose={() => setOpen(false)} wide><form className="admin-form" onSubmit={submit}>
      ...
      <label className="field field--full"><span>Custom image URL (optional)</span><input type="url" value={form.imageUrl || ''} onChange={change('imageUrl')} placeholder="Leave blank to find an exact Wikimedia Commons photo automatically" maxLength="500" /><small className="field-help">A custom non-Wikimedia URL takes priority over automatic exact-place search.</small></label>
