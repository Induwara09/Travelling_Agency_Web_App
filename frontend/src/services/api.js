...
export const destinationApi = {
  list: (search = '') => api.get('/api/destinations', { params: search ? { search } : {} }),
...
export const experienceApi = {
  list: (params = {}) => api.get('/api/experiences', { params }),
  get: (id) => api.get(`/api/experiences/${id}`),
  create: (payload) => api.post('/api/experiences', payload),
  update: (id, payload) => api.put(`/api/experiences/${id}`, payload),
  remove: (id) => api.delete(`/api/experiences/${id}`)
};
