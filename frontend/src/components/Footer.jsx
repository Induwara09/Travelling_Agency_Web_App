  ...
  return (
    <footer className="footer">
      ...
      <div className="container footer__grid">
        ...
        <div><h4>Explore</h4><Link to="/destinations">Destinations</Link><Link to="/experiences">Experiences</Link><Link to="/packages">Tour packages</Link><Link to="/hotels">Luxury stays</Link></div>
      ...
      <div className="container footer__bottom">
        ...
        <span>Original generated travel imagery. Optional Vecteezy replacements require attribution.</span>
      </div>
    </footer>
  );
}
